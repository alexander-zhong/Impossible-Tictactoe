...
# Minimax algorithm with alpha beta pruning used to determine the most optimal move (returns tuple)
def minimax(board):
    ...
    if current_player == X:
        ...
        for move in moves:
            if move == None:
                break
            temp_game_value = min_value(resultBoard(board,move), alpha_value, beta_value)
        ...
        for move in moves:
            if move == None:
                break
            temp_game_value = max_value(resultBoard(board, move), alpha_value, beta_value)
...
def max_value(board, alpha_value, beta_value):
...
def min_value(board, alpha_value, beta_value):
